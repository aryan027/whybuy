    ...
    <div class="sidebar-wrapper active">
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item {{ Request::segment(2) === 'sub-category' ? 'active' : '' }}">
                ...
                {{-- <li class="sidebar-item {{ Request::segment(2) === 'child-category' ? 'active' : '' }}">
                    <a href="{{route('child-category.index')}}" class='sidebar-link'>
                        <i class="bi bi-bookmark"></i>
